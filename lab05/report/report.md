...
subtitle: "Модель хищник-жертва - вариант 16"
...
$$
 \begin{cases}
	\frac{dx}{dt} = (-0.59x(t) + 0.058y(t)x(t))
	\\   
	\frac{dy}{dt} = (0.57y(t) - 0.056y(t)x(t))
 \end{cases}
$$

Постройте график зависимости численности хищников от численности жертв, а также графики изменения численности хищников и численности жертв 
при следующих начальных условиях: $x_0=8, y_0=18$
...
Стационарное состояние $x_0=10.172, y_0=10.178$
