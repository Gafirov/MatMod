x0 = 21050;//численность первой армии
y0 = 8900;//численность второй армии
t0 = 0;//начальный момент времени
a = 0.39;//константа, характеризующая степень влияния различных факторов на потери армии х
b = 0.84;//эффективность боевых действий армии у
c = 0.42;//эффективность боевых действий армии х
h = 0.49;//константа, характеризующая степень влияния различных факторов на потери армии у
