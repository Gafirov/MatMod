x0 = 21052;//численность первой армии
y0 = 8900;//численность второй армии
t0 = 0;//начальный момент времени
a = 0.32;//константа, характеризующая степень влияния различных факторов на потери армии х
b = 0.74;//эффективность боевых действий армии у
c = 0.44;//эффективность боевых действий армии х
h = 0.52;//константа, характеризующая степень влияния различных факторов на потери армии у
