...
subtitle: "Модель распространения рекламы - вариант 16"
...
3.	$\frac{dn}{dt} = (0.9\cos (t) + 0.9\cos (t)n(t))(N-n(t))$

При этом объем аудитории $N = 1111$, в начальный момент о товаре знает 11 человек.
